...
QT_MOC_LITERAL(3, 18, 10), // "QTextEdit*"
QT_MOC_LITERAL(4, 29, 9), // "text_edit"
QT_MOC_LITERAL(5, 39, 12), // "std::string*"
QT_MOC_LITERAL(6, 52, 10), // "IP_address"
QT_MOC_LITERAL(7, 63, 8), // "port_pub"
QT_MOC_LITERAL(8, 72, 11) // "head_letter"

    },
    "Receiver\0Receive\0\0QTextEdit*\0text_edit\0"
    "std::string*\0IP_address\0port_pub\0"
    "head_letter"
};
...
void Receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Receive((*reinterpret_cast< QTextEdit*(*)>(_a[1])),(*reinterpret_cast< std::string*(*)>(_a[2])),(*reinterpret_cast< std::string*(*)>(_a[3])),(*reinterpret_cast< std::string*(*)>(_a[4]))); break;
        default: ;
        }
